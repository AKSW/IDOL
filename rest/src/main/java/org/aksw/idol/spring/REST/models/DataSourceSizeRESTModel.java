 ...
 * 
 */
package org.aksw.idol.spring.REST.models;
...
public class DataSourceSizeRESTModel {
	...
	// public HashMap<String, SizeMap> datasourcesSize = new HashMap<String,
	// SizeMap>();
	//
	// /**
	// * Method which iterates over all distributions and create the hashmap
	// with
	...
	// ArrayList<DBObject> objects = new
	...
	// */
	// String filePath = LODVaderProperties.BASE_PATH + "/raw_files/__RAW_" +
	// distributionDB.getID();
	...
	// .getBucket(BucketDB.COLLECTIONS.BLOOM_FILTER_TRIPLES,
	// distributionDB.getID(), false)
	// .getBfByteSize();
	//
	// /**
