...
//				collection = DBSuperClass.getDBInstance().getCollection(DistributionSubjectNSDB.COLLECTION_NAME);
//			else
//				collection = DBSuperClass.getDBInstance().getCollection(DistributionObjectNSDB.COLLECTION_NAME);
//
//			// get all objects domain of a distribution
