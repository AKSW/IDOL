...
//
//		DBCollection collection = DBSuperClass.getDBInstance().getCollection(DistributionSubjectNS0DB.COLLECTION_NAME);
//
...
//		DBCollection collection = DBSuperClass.getDBInstance().getCollection(DistributionObjectNS0DB.COLLECTION_NAME);
//
//		HashSet<Integer> hash = new HashSet<Integer>();
//
//		Cursor cursor = collection.find(query);
...
//
//			DBCollection collection = DBSuperClass.getDBInstance()
...
//
//		try {
//			collection = DBSuperClass.getDBInstance().getCollection(DistributionDB.COLLECTION_NAME);
...
//			DBCollection collection = DBSuperClass.getDBInstance().getCollection(AllPredicatesDB.COLLECTION_NAME);
//
//			DBObject query;
...
//
//			collection = DBSuperClass.getDBInstance().getCollection(AllPredicatesRelationDB.COLLECTION_NAME);
