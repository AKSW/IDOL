...
//
//		DBCollection collection = DBSuperClass.getDBInstance().getCollection(AllPredicatesRelationDB.COLLECTION_NAME);
//
...
//		} else {
//			DBCollection collection2 = DBSuperClass.getDBInstance().getCollection(AllPredicatesDB.COLLECTION_NAME);
