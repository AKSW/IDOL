 ...
 * 
 */
package idol.parsers.ckanparser;
...
import idol.executors.LodVaderExecutor;
import idol.parsers.ckanparser.helpers.HTTPConnectionHelper;
import idol.parsers.ckanparser.models.CkanCatalog;
import idol.parsers.ckanparser.models.CkanDataset;
import idol.parsers.ckanparser.models.CkanDatasetAdapterV3;
import idol.parsers.ckanparser.requestoperations.CkanParserRequestOperations;
import idol.parsers.ckanparser.requestoperations.impl.V3;
import idol.parsers.ckanparser.utils.CkanUtils;
...
public class CkanParser implements CkanParserInterface {
	 ...
	 * 
	 * @see
	 * idol.parsers.ckanparser.CkanParserInterface#fetchDataset(java.lang.
	 * String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see idol.parsers.ckanparser.CkanParserInterface#fetchDatasetIds()
	 */
	@Override
