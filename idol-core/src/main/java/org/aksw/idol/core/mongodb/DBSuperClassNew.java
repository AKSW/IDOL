...
public class DBSuperClassNew <T> {
	...
	public DBSuperClassNew(DBObject obj) {
		this.mongoDBObject = obj;
	}
	
	/**
	 * Constructor for Class DBSuperClassNew 
	 */
	public DBSuperClassNew() {
	}
	...
	protected DBCollection getCollection() {
		if (collection == null) {
			...
			collection = getDBInstance().getCollection(getCollectionName());
		}
		return collection;
	}
