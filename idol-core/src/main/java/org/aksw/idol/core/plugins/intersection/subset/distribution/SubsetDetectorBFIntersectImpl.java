 ...
 * 
 */
package org.aksw.idol.core.plugins.intersection.subset.distribution;
...
import org.aksw.idol.core.mongodb.collections.Resources.GeneralResourceRelationDB.COLLECTIONS;
import org.aksw.idol.core.mongodb.collections.datasetBF.BucketDB;
import org.aksw.idol.core.plugins.LODVaderPlugin;
import org.aksw.idol.core.plugins.intersection.LODVaderIntersectionPlugin;
import org.aksw.idol.core.services.mongodb.BucketService;
 ...
 *         Oct 11, 2016
 */
public class SubsetDetectorBFIntersectImpl extends LODVaderIntersectionPlugin {
	 ...
	 * @param pluginName
	 */
	public SubsetDetectorBFIntersectImpl() {
		super(PLUGIN_NAME);
	}
	...
	public HashMap<String, List<BloomFilterI>>  loadBucketIntoCache(List<String> distributions) {
		...
		synchronized (lock) {
			if (SubsetDetectorBFIntersectImpl.loading.get()) {
				SubsetDetectorBFIntersectImpl.threadList.add(this);
				try {
					synchronized (this) {
						this.wait();
					}
				...
				SubsetDetectorBFIntersectImpl.loading.set(true);				
			}
		}
